...
<p>
<label for="hostedftp-browse"><?php _e('Browse:', 'widgets'); ?> <input style="width: 200px;" type="text" id="hostedftp-browse" name="hostedftp-browse" value="<?php echo wp_specialchars($options['browse'], true) ?>" /></label>
</p>
<p>
